...
const Technology = () => {
  ...
  return (
    ...
    <main className='main'>
        ...
        <section className='section gap-20 md:py-[40px] lg:py-[3rem] transition-all duration-700'>
          ...
          <div className='flex flex-col w-full lg:flex-row-reverse justify-center gap-12'>
          <div className={`${size.width <= 1024 ? ' max-h-[258px] md:max-h-[300px]' : ''} flex justify-center transition-all duration-700 lg:h-full lg:w-full`}><img className='w-full max-h-[300px] lg:max-h-full transition-all duration-700' src={size.width <= 1024 ? import.meta.env.BASE_URL + selectedTechnology.images.landscape : import.meta.env.BASE_URL + selectedTechnology.images.portrait} alt={selectedTechnology.name} /></div>
            <div className='flex flex-col lg:flex-row gap-6 w-full justify-between'>
              ...
              <div className='flex flex-col gap-4 lg:justify-center transition-all duration-700'>
